<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DEPARTMENT.aspx.cs" Inherits="hospitalmanagement.DEPARTMENT" %>
  ...
  <link rel="stylesheet" href="one-health/assets/css/theme.css">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function formValidator() {
            ...
            var DEPT_NM = document.getElementById("txt_DEPT_NM");
            


            // Check each input in the order that it appears in the form!
            if (notEmpty(DEPT_NM, "Department Name Must be given") ) {
...
<body>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Department</h1>
    ...
    <div style="text-align: center">
        ...
        <asp:TextBox ID="txt_DEPT_ID" CssClass="form-control" PlaceHolder="Department ID" runat="server" Enabled="False"></asp:TextBox>
        <br />
        <br />
        
        <asp:TextBox ID="txt_DEPT_NM" CssClass="form-control" PlaceHolder="Department Name" runat="server" Enabled="False"></asp:TextBox>
        <br />
        <br />
