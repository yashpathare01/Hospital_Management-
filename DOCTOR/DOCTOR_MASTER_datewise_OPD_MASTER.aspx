<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DOCTOR_MASTER_datewise_OPD_MASTER.aspx.cs" Inherits="hospitalmanagement.DOCTOR.DOCTOR_MASTER_datewise_OPD_MASTER" %>
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
              <a class="nav-link" href="../DOCT_DashBord.aspx">Dashboard</a>
            </li>
            <li class="nav-item">
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Doctor Master Datewise OPD Master</h1>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_fdate" CssClass="form-control" PlaceHolder="FROM DATE" runat="server" TextMode="Date"></asp:TextBox>
        <br />
        <br />
        
        <asp:TextBox ID="txt_tdate" CssClass="form-control" PlaceHolder="TO DATE" runat="server" TextMode="Date"></asp:TextBox>
        <br />
        <br />
