...
{
    public partial class DOCTOR_MASTER_wise_OPD_MASTER : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void btn_show_Click(object sender, EventArgs e)
        {
            cmd = new SqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "select OPD_ID,DEPT_NM,CASEPAPER.CASEPAPER_ID,OPD_DATE,CHECKUP_FEES,PROBLEM,PRESC_MEDICINE from OPD_MASTER,DEPARTMENT,CASEPAPER where DEPARTMENT.DEPT_ID=OPD_MASTER.DEPT_ID and CASEPAPER.CASEPAPER_ID=OPD_MASTER.CASEPAPER_ID and OPD_ID=" + txt_DOCT_ID.Text;
