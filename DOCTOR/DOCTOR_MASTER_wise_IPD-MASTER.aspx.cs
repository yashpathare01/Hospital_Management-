...
{
    public partial class DOCTOR_MASTER_wise_IPD_MASTER : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void btn_show_Click(object sender, EventArgs e)
        {
            cmd = new SqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "select IPD_ID,DEPT_NM,IPD_DATE,CASEPAPER.CASEPAPER_ID,WARD_NM,BED_NO,DIESE_NAME,TREATMENT from IPD_MASTER,DEPARTMENT,CASEPAPER where DEPARTMENT.DEPT_ID=IPD_MASTER.DEPT_ID and CASEPAPER.CASEPAPER_ID=IPD_MASTER.CASEPAPER_ID and IPD_ID=" + txt_DOCT_ID.Text;
