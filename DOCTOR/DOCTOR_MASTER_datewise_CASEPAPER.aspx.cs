...
{
    public partial class DOCTOR_MASTER_datewise_CASEPAPER : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void btn_show_Click(object sender, EventArgs e)
        {
            cmd = new SqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "select CASEPAPER_ID,CASE_DATE,DEPT_NM,DOCT_NAME,PAT_NM,CASEPAPER_FEES from CASEPAPER,DEPARTMENT,DOCTOR_MASTER,PATIENT_MASTER where CASEPAPER.DEPT_ID=DEPARTMENT.DEPT_ID and CASEPAPER.DOCT_ID=DOCTOR_MASTER.DOCT_ID and CASEPAPER.PAT_ID=PATIENT_MASTER.PAT_ID and CASE_DATE Between '"+txt_fdate.Text+"' and '"+txt_tdate.Text+"' and DOCTOR_MASTER.DOCT_ID=1";
