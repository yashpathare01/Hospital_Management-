<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DOCTOR_MASTER_wise_OPD_MASTER.aspx.cs" Inherits="hospitalmanagement.DOCTOR.DOCTOR_MASTER_wise_OPD_MASTER" %>
...
<body>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Doctor Master Wise OPD Master</h1>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_DOCT_ID" CssClass="form-control" PlaceHolder="Doctor ID" runat="server" TextMode="Date"></asp:TextBox>
        <br />
        <br />
