<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="hospitalmanagement.AdminLogin" %>
...
<body>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Admin Login Form</h1>
    ...
    <div style="text-align: center">
        ...
        <asp:TextBox ID="txt_admin" CssClass="form-control" PlaceHolder="Admin" runat="server"></asp:TextBox>
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Button ID="btn_log" class="btn btn-primary wow zoomIn" runat="server" OnClick="btn_log_Click" Text="Login" />
        <br />
        <br />
