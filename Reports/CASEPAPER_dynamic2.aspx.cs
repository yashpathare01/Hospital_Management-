...
{
    public partial class CASEPAPER_dynamic2 : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        public void Setdropdown()
        {
            ...
            DropDownList1.DataTextField = "DOCT_NAME";
            DropDownList1.DataValueField = "DOCT_ID";
        ...
        protected void btn_show_Click(object sender, EventArgs e)
        {
            cmd = new SqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "select CASEPAPER_ID,CASE_DATE,DEPT_NM,DOCT_NAME,PAT_NM,CASEPAPER_FEES from DOCTOR_MASTER,CASEPAPER,DEPARTMENT,PATIENT_MASTER where DEPARTMENT.DEPT_ID=CASEPAPER.DEPT_ID and DOCTOR_MASTER.DOCT_ID=CASEPAPER.DOCT_ID and PATIENT_MASTER.PAT_ID=CASEPAPER.PAT_ID and CASEPAPER.DOCT_ID=" + DropDownList1.SelectedValue;
            dr = cmd.ExecuteReader();
